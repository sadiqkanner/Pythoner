...
# URL Link 
# https://github.com/AshbyGeek/EasyWebcamCamera/blob/master/cap.py
from tkinter import*
...
def saveAndExit(event = 0):
    ...
    if (len(sys.argv) < 2):
        filepath = "C:\\Users\sadiq\Desktop\Images\imageCap5.png"
    else:
        filepath = sys.argv[1]
...
button_changeCam = tk.Button(mainWindow, text="Exit", command=changeCam)
